package com.zqq.javaailangchain4j.tools;

import com.zqq.javaailangchain4j.entity.Appointment;
import com.zqq.javaailangchain4j.service.AppointmentService;
...
//        查找数据库中是否包含对应的预约记录
        ...
        if(appointmentDB==null){
            appointment.setId(null); //防止模型幻觉设置了id
