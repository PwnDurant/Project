...
//        从一个目录中加载所有文档
        List<Document> documents=FileSystemDocumentLoader.loadDocuments("/Users/zhaoqianqian/Downloads/硅谷小智（医疗版）/资料/knowledge");

//        从一个目录中加载所有txt文档
        PathMatcher pathMatcher= FileSystems.getDefault().getPathMatcher("glob:*.txt");

//        从一个目录及其子目录中加载所有文档
        List<Document> documents1=FileSystemDocumentLoader.loadDocumentsRecursively("/Users/zhaoqianqian/Downloads/硅谷小智（医疗版）/资料/knowledge");
    }


    @Test
    public void testPDF(){
        Document document = FileSystemDocumentLoader.loadDocument("/Users/zhaoqianqian/Downloads/硅谷小智（医疗版）/资料/knowledge/医院信息.pdf", new ApachePdfBoxDocumentParser());
...
//DocumentByParagraphSplitter documentSplitter = new DocumentByParagraphSplitter(300, 30)
    ...
    public void testTokenCount(){
        String text="这是一个实例文本，用来测试token长度的计算";
